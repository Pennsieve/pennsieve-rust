...
/// An node identifier for a Pennsieve dataset (ex. N:dataset:c905919f-56f5-43ae-9c2a-8d5d542c133b).
...
/// An integer identifier for a Pennsieve dataset
#[derive(Clone, Debug, Deserialize, Eq, Hash, PartialEq, Serialize)]
